...
| SBinop ((A.String,_ ) as e1, op, e2) -> 
        ...
        (match op with
          ...
          | A.Equal ->  (L.build_icmp L.Icmp.Eq) (L.const_int i1_t 0) (L.build_call string_equality_f [| e1'; e2' |] "string_equality" builder) "tmp" builder
          | A.Neq     -> (L.build_icmp L.Icmp.Ne) (L.const_int i1_t 0) (L.build_call string_equality_f [| e1';e2' |] "string_equality" builder) "tmp" builder
